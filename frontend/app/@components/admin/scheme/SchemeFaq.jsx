    ...
    <div className="w-[90%] md:w-[80%] m-auto mt-[120px]">
      ...
      <div className="mb-10">
        ...
        <div className="w-full flex justify-end">
          <button
            type="submit"
            className={`w-full md:w-[150px] mt-5 py-2 px-4 border border-transparent rounded shadow-sm text-sm font-medium text-white focus:outline-none cursor-pointer bg-[#42d383]`}
